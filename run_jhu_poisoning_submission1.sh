...
echo "Note: This will evaluate an already generated pkl file for filtering. If you wish to re-compute the full defense, please run steps described in README.md"
